...
- Added the ``deadline_reached`` property to ``CancelScope`` to determine whether the
  scope was cancelled due to the deadline being reached, or for some other reason
