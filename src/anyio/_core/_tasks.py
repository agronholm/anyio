...
def move_on_after(
    ...
    """
    Create a context manager which exits the enclosing context block if it does not
    finish in time.
    ...
    .. versionchanged:: 5.0
        The timer now starts when the context manager is entered rather than when this
        function is called.
