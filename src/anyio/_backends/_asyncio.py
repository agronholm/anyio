...
class CapacityLimiter(BaseCapacityLimiter):
    ...
    def total_tokens(self, value: float) -> None:
        ...
        # Notify waiting tasks that they have acquired the limiter, but only while
        # there is spare capacity. Using the raw increase in total_tokens would
        # over-grant when the limiter is over-subscribed (borrowers exceeding
        # total_tokens after the limit was previously lowered below the number of
        # current borrowers).
